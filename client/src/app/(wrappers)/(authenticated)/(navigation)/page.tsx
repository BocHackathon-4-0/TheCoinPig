        ...
        >
            <div className="grid grid-cols-3 max-w-7xl gap-x-16 mt-[1335px]">
                ...
                <div className="flex flex-col justify-end items-end col-span-1 font-semibold tracking-[-4px] z-10">
                    ...
                    <h1 className="text-green-500 text-8xl">
                        Coin
                    </h1>
                ...
                <div className="flex flex-col col-span-2 justify-center h-full mt-3 z-10">
                    <h2 className="flex text-black text-3xl tracking-wide">
                        Where<p className="text-green-500 px-2 font-bold">Young</p>Savings Cultivate Financial<p className="text-pink-600 pl-2 font-bold">Success!</p>
                    </h2>
                    <div className="flex items-center justify-start h-auto">
                        <ul className="text-black font-semibold text-4xl">
                            ...
                            <p className="py-6 bg-gradient-to-r from-green-500 to-green-600 bg-clip-text text-transparent"> <TrackChangesIcon className="mx-2 text-4xl font-normal text-yellow-800"/> Set and achieve your goals</p>
                ...
                <div className="w-full bg-slate-200 flex items-center justify-center mt-12 mb-8">
                    <div className="p-4 max-w-7xl w-full">
                        ...
                        <div className="grid grid-cols-10 gap-4 pb-8">
                            ...
                            {/* Stock Card 4 */}
                            <div className="col-span-12 sm:col-span-6 md:col-span-2 border-2 border-green-400 rounded-xl">
                                <div className="flex flex-row bg-white shadow-sm rounded-xl p-2 py-4">
                                    <div className="flex flex-col flex-grow">
                                        <div className="text-sm text-gray-500">
                                            <div className="col-span-12 lg:col-span-8">
                                                <a href="#" className="rounded-full text-white bg-green-400 text-xl font-semibold mr-1 md:mr-2 mb-2 px-2 md:px-4 py-1 w-full flex items-center justify-center">
                                                    Notice Account
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div className="col-span-12 sm:col-span-6 md:col-span-2 border-2 border-green-500 rounded-xl">
                                <div className="flex flex-row bg-white shadow-sm rounded-xl p-2 py-4">
                                    <div className="flex flex-col flex-grow">
                                        <div className="text-sm text-gray-500">
                                            <div className="col-span-12 lg:col-span-8">
                                                <a href="#" className="rounded-full text-white bg-green-500 text-xl font-semibold mr-1 md:mr-2 mb-2 px-2 md:px-4 py-1 w-full flex items-center justify-center">
                                                    Total Balance
                                                </a>
                                            </div>
                                        </div>
