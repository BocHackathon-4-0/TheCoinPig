        ...
        <div className="relative w-full h-full overflow-y-auto pb-16">
            <div className="relative z-0 flex flex-col items-center justify-center w-full px-2 bg-white xxs:px-4 py-14 sm:py-12 lg:py-16 isolate lg:px-8">
                <div className="z-20 max-w-2xl mx-auto text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Withdraw without notice</h2>
                </div>
                <form action="#" method="POST" className="w-[400px] col-span-1 sm:mt-12 bg-gray-200 rounded-lg p-2">
                    <div className="sm:col-span-2 gapy-6">
                        ...
                        <div className="flex items-center justify-center gap-x-4 sm:col-span-2 h-[40px]">
                            <p className="text-black">No notice fee</p>
                            <div className="grow" />
                            <p className="text-black">20 EUR</p>
                        </div>
                    </div>
                </form>
