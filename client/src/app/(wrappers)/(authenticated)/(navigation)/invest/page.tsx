                        ...
                        <div className="mt-16 rounded-xl bg-gray-200 sm:mt-10 lg:mx-0 lg:flex lg:w-7xl">
                            <div className="p-8 sm:p-10 lg:flex-auto">
                                ...
                                <p className="mt-6 text-lg leading-7 text-gray-600">
                                    Notice accounts require advance notice for
                                    withdrawals, balancing accessibility with
                                    potentially higher interest rates.
                                </p>
                                <div className="mt-6 flex items-center gap-x-4">
                                    <h4 className="flex-none text-lg font-semibold leading-6 text-green-500">
